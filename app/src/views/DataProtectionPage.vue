    ...
    <main class="content">
      ...
      <section class="section">
        ...
        <p>
          ...
          (nachfolgend GitHub). Beim Aufruf dieser Website verarbeitet GitHub als Hoster technische
          Zugriffsdaten (z. B. IP-Adresse, Datum und Uhrzeit des Zugriffs sowie
          Browserinformationen) in Server-Logfiles. Details entnehmen Sie der Datenschutzerklärung
          von GitHub:
          <a
        ...
        <p>
          Die Nutzung von GitHub Pages erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir
      ...
      <section class="section">
        ...
        <p>
          ...
          die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z.
